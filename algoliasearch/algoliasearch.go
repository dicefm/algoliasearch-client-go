...
type Client interface {
	...
	// optional parameters.
	AddKey(ACL []string, params Params) (res AddKeyRes, err error)

	// UpdateKeyWithParam updates the API key named `key` with the supplied
	// parameters.
	UpdateKeyWithParam(key string, params Params) (res UpdateKeyRes, err error)
	...
	GetLogs(params Params) (logs []LogRes, err error)
	...
	GenerateSecuredAPIKey(apiKey string, params Params) (key string, err error)
	...
	MultipleQueries(queries []map[string]interface{}, indexField, strategy string) (res []MultipleQueryRes, err error)
...
type Index interface {
	...
	SetSettings(settings map[string]interface{}) (res UpdateTaskRes, err error)
	...
	SearchSynonyms(query string, types []string, page, hitsPerPage int) (synonyms Synonyms, err error)
	...
	Browse(params Params) (res BrowseRes, err error)
